...
CREATE TABLE `event` (
  ...
  `period` enum('préhistoire','Antiquité','Moyen-Âge','Renaissance','XVIIe siècle','XVIIIe siècle','Directoire, Consulat','Ier Empire','Période Romantique','Second Empire','IIIe République','Belle Époque','1re GM','Entre deux guerres','2nde GM','1945 et plus') NOT NULL,
